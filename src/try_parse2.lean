...
meta def main : io unit := do {
  ...
  --candidate ← args.nth_except 0 "candidate",
  --candidate2 ← args.nth_except 1 "candidate2",
  --candidate3 ← args.nth_except 2 "candidate3",
  --candidate4 ← args.nth_except 3 "candidate",
  --candidate5 ← args.nth_except 4 "candidate",
